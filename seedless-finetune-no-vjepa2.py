...
def main(args):
   ...
   # Load the base config from the pretrained checkpoint
    ...
    if ("vivit" in args.model_name):
        ...
        model = VivitForVideoClassification.from_pretrained(base_model_name, config=config, ignore_mismatched_sizes=ignore_mismatched_sizes)
    ...
    # for fold in range(n_splits):
        ...
        for epoch in range(num_epochs):
            ...
            for i, batch in enumerate(train_loader):
                ...
                print("Pixel values shape after the dataloader_class:", pixel_values.shape)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--model_name",
        type=str,
        default="facebook/timesformer-base-finetuned-ssv2",
        # default="facebook/timesformer-base-finetuned-k600",
