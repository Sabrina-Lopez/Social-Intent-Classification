...
data_files = {"test": "test_data_33_unmod.csv"}
# data_files = {"test": "test_data.csv"}
...
base_model_name = "timesformer-finetuned-train" + dataset_type[4:]
...
plt.legend()
plt.grid(True)
plt.savefig(f'Finetune_Timesformer_{dataset_type}_metrics.png')
